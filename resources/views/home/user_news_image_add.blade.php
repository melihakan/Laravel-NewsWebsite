...
<head>
    ...
    <link href="{{ asset('assets')}}/admin/dist/css/pages/dashboard1.css" rel="stylesheet">
            ...
            <div class="card body-primary">
                ...
                <div class="card-body">
                    <div class="card">
                        <form class="form p-t-20" action="{{route('user_image_store',['news_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <table id="myTable" class="table table-bordered table-striped">
                                ...
                                @foreach ($images as $rs)
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('user_image_delete',['id' => $rs->id,'news_id'=>$data->id])}}" onclick="return confirm('Are You Sure ?')">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
