    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="card body-primary">
                ...
                <div class="card-body">
                    <div class="card">
                        <form class="form p-t-20" action="{{route('admin_faq_update',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="pwd1">Position</label>
                                <div class="input-group mb-3">

                                    <input type="number" id="title" name="position" value="{{$data->position}}" class="form-control"
