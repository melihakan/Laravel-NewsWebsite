                                        ...
                                        <table id="myTable" class="table table-bordered table-striped">
                                            ...
                                            @foreach ($datalist as $rs)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('news',['id'=>$rs->news->id,'slug'=>$rs->news->slug])}}">{{$rs->news->title}}</a>
                                                    </td>
                                                    <td>{{$rs->subject}}</td>
                                                    <td>{{$rs->review}}</td>
                                                    <td>{{$rs->rate}}</td>
                                                    ...
                                                    <td><a href="{{route('admin_review_delete',['id'=> $rs->id])}}" onclick="return confirm('Delete, Are you Sure ?')" data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i></a></td>
                                                </tr>
